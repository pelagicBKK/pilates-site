  ...
  return (
    <Fragment>
      <Grid container spacing={4}> 
        <Grid item xs={6} >
          <Card className="card-box p-4 text-center mb-4 shadow-lg p-3 mb-5 bg-white rounded"
              ...
              <Grid
                ...
                <div>
                  ...
                  {/* <Circle
                    ...
                    progressColor="#B68EBC" // String: Color of "progress" portion of circle.
                    bgColor="#e8e9ef" // String: Color of "empty" portion of circle.
                    textColor="#3b3e66" // String: Color of percentage text color.percentSpacing={10} // Number: Adjust spacing of "%" symbol and number.
                    roundedStroke={true}
                    textStyle={{
